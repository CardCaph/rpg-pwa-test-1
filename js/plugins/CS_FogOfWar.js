...
(function($) {
    ...
    // Fog Bitmap
    $.bitmap = new Bitmap(16, 16); //pin: resize to 16 x 16
    ...
    FogSprite.prototype.update = function() {
        ...
        this.x = (this.tileX - displayX + Math.floor(displayX)) * 16; //pin 16
        this.y = (this.tileY - displayY + Math.floor(displayY)) * 16; //pin 16
    }
    // ===Fog Sprite Prototype===
    ...
    Spriteset_Map.prototype.createCharacters = function() {
        ...
        let width = Graphics.width / 16 + 1; //pin 16
        let height = (Graphics.height / 12 + 1); //pin 16
        ...
        for (var i = 0; i < width; i++) {
            ...
            for (var j = 0; j < height; j++) {
                ...
                this.tileX = i;
                this.tileY = j;
                sprite.x = i*16;//pin 16
                sprite.y = j*16;//pin 16
            }
        }
    ...
    Game_CharacterBase.prototype.initialize = function() {
        ...
        //pin fog transparency
		this._fogTransparent = false;
		//
    ...
    Game_CharacterBase.prototype.update = function() {
        ...
        this.updateFloor();
        //pin set FOW as hider for events
		this._fogTransparent = $._fog_tiles[this._x][this._y].targetOpacity > 0 ? true : false; 
